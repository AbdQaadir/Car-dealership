...
const CreateCars = (() => {
  ...
  function produceCars() {
    makeCar("chery", "american");
    makeCar("bmw", "german", "assets/german-car1.jpeg", true);
    makeCar("toyota", "german", "assets/german-car2.jpeg", false);
    makeCar("mercedes", "german", "assets/german-car3.jpeg", false);
    makeCar(
      "mercedes",
      "german",
      "assets/german-car4.jpeg",
      undefined,
      "other model"
    );
    makeCar("mercedes", "german", "assets/german-car4.jpeg", false);
    makeCar("chevy", "american", "assets/american-car1.jpeg", true);
    makeCar("chevy", "american", "assets/american-car2.jpeg", true);
    makeCar("chevy", "american", "assets/american-car3.jpeg", false);
    makeCar("chevy", "american", "assets/american-car4.jpeg", false);
    makeCar("chevy", "american", "assets/american-car5.jpeg", false);
  }
  produceCars();
  // console.log(cars);
  //special cars
            ...
            <div class="card-body">
                <div class="car-info d-flex justify-content-between">
                    ...
                    <h5 class="car-value align-self-center-py-2 px-3">$
                        <span class="car-prize">${car.price}</span>
                    </h5>
                </div>
            </div>
            <!-- end of card -->
